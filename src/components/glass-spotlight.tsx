    ...
    <div className="fixed inset-0 z-50">
      ...
      <div
        ...
        style={{
          ...
          width: targetRect.width + padding * 2,
          height: targetRect.height + padding * 2,
          boxShadow: "0 0 0 2px var(--dunn-purple-light), 0 0 20px var(--glow-primary)",
        }}
      />
      ...
      >
        <div className="relative">
          {/* Glow */}
          <div className="absolute -inset-2 rounded-xl bg-linear-to-r from-dunn-purple/30 to-dunn-purple-light/30 blur-lg opacity-70" />
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    "bg-linear-to-r from-dunn-purple to-dunn-purple-light text-white",
                    "hover:from-dunn-purple-light hover:to-dunn-purple transition-all",
                  )}
                >
