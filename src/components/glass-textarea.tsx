    ...
    return (
      <div className="relative w-full">
        ...
        >
          {glowOnFocus && (
            <motion.div
              className="absolute -inset-0.5 rounded-xl bg-gradient-to-r from-dunn-purple/0 via-dunn-purple-light/0 to-dunn-purple/0 blur-md group-focus-within:from-dunn-purple/30 group-focus-within:via-dunn-purple-light/30 group-focus-within:to-dunn-purple/30 transition-all duration-300"
              aria-hidden="true"
            />
          )}
          <textarea
            ...
            className={cn(
              ...
              "focus:ring-2 focus:ring-dunn-purple/30 focus:ring-offset-0",
