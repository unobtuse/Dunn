...
const rippleColors = {
  purple: "bg-dunn-purple/30",
  green: "bg-dunn-green/30",
  white: "bg-white/30",
}
...
interface GlassRippleButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  rippleColor?: "purple" | "green" | "white"
}
...
const GlassRippleButton = React.forwardRef<HTMLButtonElement, GlassRippleButtonProps>(
  ({ className, children, variant = "default", rippleColor = "white", ...props }, ref) => {
    ...
    const variants = {
      ...
      primary:
        "bg-linear-to-r from-dunn-purple via-dunn-purple-dark to-dunn-purple backdrop-blur-xl border border-dunn-purple-light/30 text-white",
