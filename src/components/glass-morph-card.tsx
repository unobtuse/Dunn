...
const glowColors = {
  purple: "from-dunn-purple/40 to-dunn-purple-light/40",
  green: "from-dunn-green/40 to-dunn-green-light/40",
}

const GlassMorphCard = React.forwardRef<HTMLDivElement, GlassMorphCardProps>(
  ({ className, children, intensity = 15, glowColor = "purple", disabled = false, ...props }, ref) => {
