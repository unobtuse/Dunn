  ...
  ),
  {
    variants: {
      variant: {
        ...
        primary: cn(
          "bg-linear-to-r from-dunn-purple via-dunn-purple-dark to-dunn-purple",
          "backdrop-blur-xl border border-dunn-purple-light/30 text-white",
          "shadow-[0_4px_20px_var(--glow-primary)]",
          "hover:shadow-[0_4px_30px_var(--glow-primary)]",
          "before:absolute before:inset-0 before:rounded-xl",
  ...
  ({ className, variant, asChild = false, size, glowEffect = false, children, ...props }, ref) => {
    ...
    return (
      <div className="relative inline-block">
        {glowEffect && (
          <div className="absolute -inset-1 rounded-xl bg-linear-to-r from-dunn-purple/40 via-dunn-purple-light/40 to-dunn-purple/40 blur-lg opacity-70 transition-opacity group-hover:opacity-100" />
        )}
